...
import GetAllCompany from '../Pages/getAllCompanyPage';
import GetOneCompany from '../Pages/GetOneCompanyPage';
import GetOneCustomer from '../Pages/GetOneCustomerPage';
import GetAllCustomers from '../Pages/GetAllCustomers';
